...
class VodPage extends Component {
  ...
  handleSubmit = event => {
    ...
    newTimestamps.forEach(function(x) {
      timestampObject[x] = (timestampObject[x] || 0) + 1;
    });
  ...
  render() {
    return (
      <div className="vod-page-container">
        <TableCard title={'General Data'}>
          <div className="main-content">
            <InfoCard
              ...
              data={this.state.topTenChatters}
            />
            ...
            <div className="broadcaster-info">
              ...
              <ContentCard title={'Broadcaster Info'}>
                <div>
                  ...
                  <a href={this.state.broadcasterChannel}>
                    {this.state.broadcasterChannel}
                  </a>
                </div>
              </ContentCard>
            ...
            <InfoCard
              title={'Most Copied Messages'}
              data={this.state.topTenMessages}
            />
          </div>
        </TableCard>
        ...
        <TableCard
          className="chart-div"
          title={'Message Frequency / Notable spikes in messages'}
        >
